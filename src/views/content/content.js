...
// };
// const blogList: blog[] = [];
// const initArticle: articleType = {};
function Content(props) {
    const [article, setArticle] = React.useState({});
    const [lastBlog, setLastBlog] = React.useState([]);
    const [nextBlog, setNextBlog] = React.useState([]);
    const [isLiked, toggleIsliked] = useToggle(false);
    const { location } = props;
    const fetchLastNextBlog = React.useCallback(() => {
