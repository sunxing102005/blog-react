...
window.scrollReveal = (function(window) {
    ...
    scrollReveal.prototype = {
        ...
        update: function(el) {
            ...
            var style = this.styleBank[
                el.getAttribute("data-scroll-reveal-id")
            ];
        ...
        genCSS: function(el) {
            ...
            if (parsed.enter) {
                ...
                if (
                    this.options.enter == "top" ||
                    this.options.enter == "bottom"
                ) {
                ...
                if (
                    this.options.enter == "left" ||
                    this.options.enter == "right"
                ) {
                    enter = this.options.enter;
                    axis = "x";
                }
